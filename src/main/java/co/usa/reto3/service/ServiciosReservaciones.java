...
import co.usa.reto3.model.reporte.ContClientes;
import co.usa.reto3.model.reporte.ContEstadoReservaciones;
...
public class ServiciosReservaciones {
    ...
    public ContEstadoReservaciones reporteStatusServicio (){
        ...
        return new ContEstadoReservaciones(completed.size(), cancelled.size() );
    }
    ...
    public List<Reservaciones> reporteTiempoServicio (String datoA, String datoB){
     ...
     public List<ContClientes> reporteClientesServicio(){
